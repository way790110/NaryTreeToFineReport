...
class Program
{
    static void Main()
    {
        ...
        string connectionString = "Server=TPEFPG233980\\TESTDB;Database=IntelligentService;User Id=sa;Password=123;Encrypt=True;TrustServerCertificate=True;";
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            try
            {
                ...
                // 創建 SqlCommand 對象
                string query = "SELECT * FROM TN_EQUIP_TYPE";
        ...
        */
        ...
        // 查詢語句
        // string query = "SELECT * FROM CN_EQUIP_TYPE";
        string query = @"
            WITH SUM_VALUE AS (
                SELECT 
                    CN_EQUIP_ID,  
